  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed left-[50%] top-[50%] z-50 grid w-[min(92vw,960px)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-xl border border-slate-700 bg-slate-950 p-5 text-slate-100 shadow-2xl",
          className,
        )}
        {...props}
      >
