  ...
  "fixed z-50 flex h-auto flex-col gap-4 overflow-x-hidden border border-slate-700 bg-slate-950 p-4 text-slate-100 shadow-2xl duration-300 sm:p-6",
  {
    variants: {
      side: {
        ...
        left: "inset-y-0 left-0 h-full w-[92vw] max-w-[640px] border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left data-[state=open]:animate-in data-[state=closed]:animate-out",
        right:
          "inset-y-0 right-0 h-full w-[92vw] max-w-[640px] border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right data-[state=open]:animate-in data-[state=closed]:animate-out",
      },
    },
    defaultVariants: {
      side: "right",
  ...
  return (
    <DrawerPortal>
      ...
      >
        <div
          className={cn(
            "mx-auto mt-1 hidden h-2 w-[100px] rounded-full bg-slate-700",
